# HM64 Autobuilder
This is a simple repository to automatically obtain new release tags (twice per day) and if there is a new release, build it for linux aarch64. The releases contain binaries and required files for the following:
